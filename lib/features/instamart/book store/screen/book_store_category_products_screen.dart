...
import 'package:swiggy_clone/features/instamart/widgets/categories/product_card.dart' show ProductCard;
import 'package:swiggy_clone/features/instamart/widgets/grocery/grocery_sidebar.dart';
import '../data/book_store_mock_data.dart';


class BookStoreCategoryProductsScreen extends StatefulWidget {
  final String categoryName;
  final String selectedSubCategory;

  const BookStoreCategoryProductsScreen({
    super.key,
    required this.categoryName,
    this.selectedSubCategory = 'Deals',
  });

  @override
  State<BookStoreCategoryProductsScreen> createState() =>
      _BookStoreCategoryProductsScreenState();
}

class _BookStoreCategoryProductsScreenState
    extends State<BookStoreCategoryProductsScreen> {
  ...
  void initState() {
    ...
    availableSidebarCategories =
        BookStoreMockData.categorySubCategories['Deals'] ?? [];
  ...
  num get totalCartPrice {
    num total = 0;
    BookStoreMockData.catalogProducts.forEach((_, products) {
  ...
  Widget build(BuildContext context) {
    final List<ProductModel> activeProducts =
        BookStoreMockData.catalogProducts[activeSubCat] ?? const <ProductModel>[];
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Padding(
        ...
        child: Text(
          'No books available in "$activeSubCat" yet.',
