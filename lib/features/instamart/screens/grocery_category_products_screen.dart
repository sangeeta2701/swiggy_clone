...
class GroceryCategoryProductsScreen extends StatefulWidget {
  ...
  const GroceryCategoryProductsScreen({
    ...
    this.selectedSubCategory = 'Atta',
  });

  @override
  State<GroceryCategoryProductsScreen> createState() =>
...
class _GroceryCategoryProductsScreenState
  ...
  num get totalCartPrice {
    num total = 0;
    GroceryMockData.catalogProducts.forEach((_, products) {
