...
import '../data/beauty_mock_data.dart';
...
class BeautyCategoryProductsScreen extends StatefulWidget {
  final String categoryName;
  final String selectedSubCategory;

  const BeautyCategoryProductsScreen({
    super.key,
    required this.categoryName,
    this.selectedSubCategory = 'Bath and Body',
  });

  @override
  State<BeautyCategoryProductsScreen> createState() =>
      _BeautyCategoryProductsScreenState();
}

class _BeautyCategoryProductsScreenState
    extends State<BeautyCategoryProductsScreen> {
  ...
  void initState() {
    ...
    BeautyMockData.categorySubCategories.forEach((key, list) {
    ...
    availableSidebarCategories =
        foundList ?? BeautyMockData.categorySubCategories.values.first;
  ...
  num get totalCartPrice {
    num total = 0;
    BeautyMockData.catalogProducts.forEach((_, products) {
  ...
  Widget build(BuildContext context) {
    final List<ProductModel> activeProducts =
        BeautyMockData.catalogProducts[activeSubCat] ?? const <ProductModel>[];
